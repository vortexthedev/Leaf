...
public class MCBugFix extends ConfigModules {
    ...
    public static boolean mc270656 = true;
    public static boolean mc301114 = true;
    ...
    public void onLoaded() {
        ...
        mc301114 = config.getBoolean(getBasePath() + ".mc-301114", mc301114,
            """
        ...
        mc301114maxCombatEntries = config.getInt(getBasePath() + ".mc-301114-max-entries", mc301114maxCombatEntries,
            "Max allowed entries in mob's combat tracker.");

        mc301114maxCombatEntries = Math.max(1, mc301114maxCombatEntries);

        mc152094 = config.getBoolean(getBasePath() + ".mc-152094", mc152094,
            """
